        ...
        <div className="timeline">
          <div className="timeline-container primary">
            ...
            <div className="timeline-body">
              ...
              <p>
                I am currently persuing my B. Tech in Computer Science from MIT
                AOE, Pune, With a CGPA of 8.99 (Sem 7).
              </p>
          ...
          <div className="timeline-container danger">
            ...
            <div className="timeline-body">
              ...
              <p>
                I completed my 12th from Blossom Public School, Pune with 92% in
                PCM, CBSE board.
              </p>
          ...
          <div className="timeline-container success">
            ...
            <div className="timeline-body">
              ...
              <p>
                I completed my 10th from Podar International School, Pune with
                95.6%, CBSE board.
              </p>
